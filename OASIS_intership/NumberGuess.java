...
class NumberGuess {
    ...
    public static void main(String[] args) {
        ...
        int range = random.nextInt(100) + 1; // Generate random number between 1 and 100
        ...
        while (attempt <= 5) {
            ...
            if (guess == range) {
                System.out.println(
                        "Congratulations! You guessed the number " + range + " in " + attempt + " attempt(s).");
                System.out.println("Your Score is: " + (6 - attempt) * 10);
                break;
            } else if (guess > range) {
                System.out.println("Your guess is higher. Try a lower number.");
            } else {
                System.out.println("Your guess is lower. Try a higher number.");
            }
